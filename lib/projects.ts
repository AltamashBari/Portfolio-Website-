...
export const projects: Project[] = [
  ...
  {
    slug: "mustafa-residence-renovation",
    title: "Dr. Mustafa Residence Renovation",
    category: "Interior",
    ...
    intro:
      "Dr. Mustafa Residence Renovation is a full interior renovation of a private residence in Lakhimpur, India, currently in design development and construction. Rather than treating each space differently, the scheme reworks five principal rooms — the master bedroom, dressing and wardrobe room, home office, reading and library corner, and galley kitchen — around a single, restrained material language of warm neutrals, natural timber and brass.",
    cover: img(
    ...
    story: [
      {
        heading: "Project Overview",
        body: "Dr. Mustafa Residence Renovation is a full interior renovation of a private residence in Lakhimpur, India, currently in design development and construction. The brief covers five principal rooms — master bedroom, dressing and wardrobe room, home office, reading and library corner, and galley kitchen — each renovated in turn but designed as one continuous material story rather than five unrelated rooms.",
      },
      {
        heading: "A Warm, Contemporary Material Language",
        body: "Every room is held together by the same restrained palette: warm neutrals grounded in natural timber, lifted with brass, and quietened with soft, layered light. Walls stay in calm ivory and greige so that texture — fluted timber, channel-tufted upholstery, textured stone and glass — carries the interest, while joinery moves from pale reeded oak in the bedrooms to deep walnut in the study, always detailed with the same vertical, fluted rhythm so the rooms read as one family. Concealed cove, toe-kick and under-cabinet LED lighting runs throughout at a warm 2700–3000K, modelling the surfaces gently and giving each room a warm glow after dark.",
        table: [
          { label: "Walls & Ceiling", value: "Warm ivory emulsion, taupe/greige emulsion, gypsum ceiling & cornice" },
          { label: "Joinery & Timber", value: "Walnut veneer (matte), oak reeded veneer, greige laminate/lacquer" },
          { label: "Surfaces & Stone", value: "Cream quartz counter, travertine-tone mosaic, cream vitrified tile" },
          { label: "Metal & Hardware", value: "Antique/PVD brass, champagne aluminium, matte-black steel" },
          { label: "Soft Furnishings", value: "Oatmeal upholstery, mushroom weave, olive accent" },
          { label: "Light", value: "Warm-white LED 2700–3000K, concealed cove/toe-kick, brass accent fittings" },
        ],
      },
      {
        ...
        images: [
          img("mustafa-residence-renovation", "01-master-bedroom.jpg", 1600, 718, "Rendered view of the master bedroom with a channel-tufted oatmeal headboard, fluted oak wardrobe and TV wall, and a walnut-framed window", "Master Bedroom"),
          img("mustafa-residence-renovation", "01-master-bedroom-left.jpg", 1600, 720, "Rendered view of the master bedroom angled toward the fluted oak wardrobe and dressed window, with the upholstered headboard alcove", "Master Bedroom — Window & Wardrobe Wall"),
          img("mustafa-residence-renovation", "01-master-bedroom-right.jpg", 1600, 720, "Rendered view of the master bedroom angled toward the walnut TV wall with its floating console and stone display plinth", "Master Bedroom — TV Wall"),
          img("mustafa-residence-renovation", "01-master-bedroom-ceiling.jpg", 1600, 720, "Wide rendered view of the master bedroom showing the ceiling fan, cove lighting and the room in full", "Master Bedroom — Full Room View"),
        ],
        table: [
          ...
          { label: "Headboard", value: "Full-height channel-tufted upholstery in oatmeal poly-linen, on an engineered-wood frame" },
          { label: "Wardrobe & Doors", value: "Reeded/fluted shutters in oak-walnut veneer, matte PU lacquer; antique-brass elongated pull handles; integrated mirror leaf" },
          { label: "TV Wall & Console", value: "Vertically fluted wood-veneer feature panel with floating oak console; concealed warm-white LED under-lighting" },
          { label: "Ceiling", value: "Gypsum false ceiling with recessed cove and plaster crown cornice" },
          { label: "Lighting", value: "2700–3000K recessed LED downlights, concealed cove glow behind headboard, antique-brass opal-globe wall sconce" },
          { label: "Window & Drapery", value: "Solid-wood casement in dark walnut stain with grid mullions; sheer inner + oatmeal cotton-linen pinch-pleat drapes on matte-black rod" },
          { label: "Flooring", value: "800×800 marble-finish vitrified tile with a wool-jute area rug" },
        ],
      },
      {
        ...
        images: [
          img("mustafa-residence-renovation", "02-dressing-wardrobe.jpg", 1600, 718, "Rendered view of the dressing and wardrobe room with a floor-to-ceiling greige wardrobe run, built-in vanity and curved channel-tufted sofa", "Dressing & Wardrobe Room"),
          img("mustafa-residence-renovation", "02-dressing-wardrobe-left.jpg", 1600, 720, "Rendered view of the dressing and wardrobe room from the entry, showing the full wardrobe run and the backlit vanity mirror", "Dressing & Wardrobe Room — Entry View"),
          img("mustafa-residence-renovation", "02-dressing-wardrobe-right.jpg", 1600, 720, "Rendered view of the dressing and wardrobe room showing the backlit oval vanity mirror, open display niches and the walk-in closet door", "Dressing & Wardrobe Room — Vanity Detail"),
          img("mustafa-residence-renovation", "02-dressing-wardrobe-ceiling.jpg", 1600, 720, "Wide rendered view of the dressing and wardrobe room showing the ceiling fan and the full wardrobe and vanity wall", "Dressing & Wardrobe Room — Full Room View"),
        ],
        table: [
          ...
          { label: "Vanity / Dresser", value: "Matching greige lacquer unit with quartz top; LED-halo backlit oval mirror on a fluted backdrop; back-lit open display niches" },
          { label: "Seating", value: "Curved channel-tufted three-seater in mushroom woven fabric with olive & beige cushions; bouclé vanity chair on slim metal legs" },
          { label: "Coffee Table", value: "Two-tier oval table, stone top on a brushed-gold metal frame" },
          { label: "Ceiling & Lighting", value: "Recessed downlights, matte-black surface spots, concealed vertical & toe-kick LED wash, brushed-gold wall sconce" },
          { label: "Doors", value: "Solid-wood panel doors in walnut stain — arched-panel entry, flush secondary door" },
          { label: "Flooring", value: "Engineered oak-tone laminate with a neutral wool-blend rug" },
        ],
      },
      {
        heading: "Home Office",
        ...
        images: [
          img("mustafa-residence-renovation", "03-home-office.jpg", 1600, 721, "Rendered view of the home office with a solid-wood walnut desk, high-back task chair and walnut wall shelving", "Home Office"),
          img("mustafa-residence-renovation", "03-home-office-left.jpg", 1600, 720, "Rendered view of the home office showing the cushioned window seat, walnut entry door and the desk nook beyond", "Home Office — Window Seat & Entry"),
          img("mustafa-residence-renovation", "03-home-office-right.jpg", 1600, 720, "Rendered view of the home office desk nook with its walnut shelving, task lamp and the sheer-curtained window beyond", "Home Office — Desk Nook"),
          img("mustafa-residence-renovation", "03-home-office-ceiling.jpg", 1600, 720, "Wide rendered view of the home office showing the window seat, entry door and desk nook together", "Home Office — Full Room View"),
        ],
        table: [
          ...
          { label: "Seating", value: "High-back ergonomic task chair upholstered in mocha fabric" },
          { label: "Wall Storage", value: "Walnut cube display shelf and floating shelf with concealed under-shelf LED; framed cork pinboard" },
          { label: "Walls", value: "Warm taupe matte emulsion" },
          { label: "Window Treatment", value: "Zebra dual-roller blind under a chunky walnut pelmet; dark-wood window frame; side pinch-pleat drape on matte-black rod" },
          { label: "Door", value: "Solid walnut four-panel door with brass lever handle" },
          { label: "Lighting", value: "Recessed warm downlights, LED strip under the floating shelf, articulated black-metal task lamp" },
          { label: "Flooring", value: "Engineered oak-tone laminate" },
        ],
      },
      {
        ...
        images: [
          img("mustafa-residence-renovation", "04-reading-library.jpg", 1600, 718, "Rendered view of the reading and library corner with walnut display shelving, a backlit niche and a black-steel bookcase", "Reading & Library Corner"),
          img("mustafa-residence-renovation", "04-reading-library-left.jpg", 1600, 720, "Rendered view of the reading and library corner showing the cushioned window seat beside the walnut display shelving", "Reading & Library Corner — Window Seat"),
          img("mustafa-residence-renovation", "04-reading-library-right.jpg", 1600, 720, "Rendered view of the reading and library corner's walnut display shelving with the backlit niche and entry door beyond", "Reading & Library Corner — Shelving Detail"),
          img("mustafa-residence-renovation", "04-reading-library-ceiling.jpg", 1600, 720, "Wide rendered view of the reading and library corner showing the window seat, bookcase and entry door together", "Reading & Library Corner — Full Room View"),
        ],
        table: [
          { label: "Display Boxes", value: "Wall-mounted walnut open box shelves with concealed warm-white LED interiors" },
          { label: "Niche Shelf", value: "Long horizontal walnut niche with fluted back panel and grazing LED wash" },
          { label: "Book Unit", value: "Free-standing shelf on a powder-coated black mild-steel cross-braced frame with walnut shelves and a fluted-shutter base cabinet" },
          { label: "Walls", value: "Ivory matte emulsion" },
          { label: "Window Treatment", value: "Zebra roller blind beneath a solid walnut pelmet; dark-wood frame" },
          { label: "Door", value: "Solid walnut panel door with boxed timber lintel/architrave" },
          { label: "Lighting", value: "Recessed downlights plus concealed niche LED" },
          { label: "Flooring", value: "Large-format cream vitrified tile" },
        ],
      },
      {
        ...
        images: [
          img("mustafa-residence-renovation", "05-modern-kitchen.jpg", 1600, 721, "Rendered view of the galley kitchen with greige cabinetry, gold hardware, fluted glass upper cabinets and integrated appliances", "Modern Galley Kitchen"),
          img("mustafa-residence-renovation", "05-modern-kitchen-left.jpg", 1600, 720, "Rendered view of the galley kitchen's hob run with the fluted tile backsplash, sink and the utility door beyond", "Modern Galley Kitchen — Hob & Backsplash"),
          img("mustafa-residence-renovation", "05-modern-kitchen-right.jpg", 1600, 720, "Rendered view of the galley kitchen's built-in oven and microwave tower beside the tall integrated refrigerator", "Modern Galley Kitchen — Oven Tower"),
          img("mustafa-residence-renovation", "05-modern-kitchen-ceiling.jpg", 1600, 720, "Wide rendered view of the galley kitchen showing the hob run, utility door and oven tower together", "Modern Galley Kitchen — Full Room View"),
        ],
        table: [
          ...
          { label: "Hardware", value: "Slim gold / PVD-brass profile handles; soft-close hinges and drawer channels" },
          { label: "Countertop", value: "20mm engineered quartz in a cream terrazzo-fleck finish" },
          { label: "Backsplash", value: "Stacked vertical mini-brick (kit-kat) mosaic in cream travertine tone" },
          { label: "Appliances", value: "Built-in oven + microwave tower, black glass gas hob, wall-mounted black chimney, integrated tall refrigerator, stainless undermount sink with pull-out faucet" },
          { label: "Lighting", value: "Under-cabinet LED task profile in warm white; high-level ventilator window for daylight" },
          { label: "Utility Door", value: "Flush laminate door in walnut tone with matte-black lever handle" },
          { label: "Flooring", value: "800×800 cream matte vitrified tile" },
        ],
      },
      {
        heading: "Materials & Detailing Notes",
        body: "Finishes above are set out to design-development level; exact shades, brands and hardware are confirmed against physical samples during detailing as the project moves into construction. The renders shown throughout this page illustrate design intent for each room rather than a fixed, final specification.",
      },
    ],
    specs: [
      { label: "Type", value: "Residential Interior Renovation" },
      { label: "Client", value: "Dr. Mustafa" },
      { label: "Location", value: "Lakhimpur, India" },
      { label: "Status", value: "Design Development & Construction" },
      { label: "Scope", value: "5 Rooms — Bedroom, Dressing Room, Office, Library Corner, Kitchen" },
    ],
  },
  {
